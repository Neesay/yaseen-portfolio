...
<html lang="en">
    ...
    <body id="grid">
        ...
        <figure class="me">
            <img src="media/me-blue.png" alt="me">
        </figure>
        <figure class="grey-box">
            <img src="media/grey-box-2.png" alt="background">
        </figure>
        <figure class="purple-box">
            <img src="media/dark-purple.png" alt="background">
        </figure>
        <figure class="blue-box">
            <img src="media/blue.png" alt="background">
        </figure>
        <figure class="p1">
