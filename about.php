    ...
    <body id="grid">
        ...
        <main class="about-box">
            <div class="container">
                ...
                <br>
                <p>
                    An inquisitive and quality-oriented person currently studying Computer Science at Queen Mary University of London. Confidence, optimism and enthusiasm are the key elements to my ecstatic personality that drive my conscientiousness. My career aim is to research in developing AI models that solve intricate problems that cannot be even fathomed by humans.
                </p>
            </div>
        </main>
        <figure class="p1">
