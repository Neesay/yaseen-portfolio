...
<html lang="en">
    <head>
        ...
        <script src="scripts/previewBlog.js" defer></script>
            ...
            if ($_SESSION['loggedIn'] == true) {
                echo'<div class="blog-box">
                        <div class="containerBlog">
                            ...
                            <div class="viewBlog2">
                                <article class="viewBlog-box">
                                    <h3>' . $_SESSION['title'] . '</h3>
                                    <p>' . $_SESSION['content'] . '</p>
                                    <p class="time"><time>' . $_SESSION['currentDate'] . '</time></p>
                                </article>
                            </div>';
                ?>

                <script>
                    const title = "<?php echo $_SESSION['title']; ?>";
                    const content = "<?php echo $_SESSION['content']; ?>";
                </script>
